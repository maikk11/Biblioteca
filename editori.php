...
<body>
    ...
    <br/>
    <h3>Editori</h3>
    <a href="create_editore.php">+ AGGIUNGI UN EDITORE</a>
    <br/>
    <br/>
    <table border="1">
    <tr>
        ...
        $query = mysqli_query($conn,"select * from Editori") or die(mysql_error());;

        # Stampa un messaggio se non ci sono libri nel database
        if(mysqli_num_rows($query) == 0) {
           echo '<tr style="background-color: #ff4d4d"><td colspan="8"><center>Nessun editore presente!</center></td></tr>';
           }
           else{
        ...
        ?>
           <tr>
               ...
               <td>
                  <a href="update_editore.php?id=<?php echo $data['idEditore']; ?>">EDIT</a>&nbsp;&nbsp;
                  <a href="delete_editore.php?id=<?php echo $data['idEditore']; ?>" onclick="return checkDelete()">DELETE</a>
               </td>
           </tr>
        <?php
            }
