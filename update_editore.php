...
<body>
    ...
    <br/>
    <br/>
    <h3>Aggiorna un editore</h3>

        <?php
        include 'conn.php';
        $idEditore = $_GET['id'];
        $query = mysqli_query($conn,"select * from editori where idEditore='$idEditore'");
        while($data = mysqli_fetch_array($query)){
                ?>
           <form method="post" action="update_editore_db.php" onsubmit="return handleData()">
                <table cellpadding="3" cellspacing="0">
                     ...
                     <tr>
                         <td>Nome</td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                         <td>
                           <input type="hidden" name="idEditore" value="<?php echo $data['idEditore']; ?>">
                     ...
                     <tr>
                         <td>Città</td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                         <td>
                           <input type="text" name="citta" value="<?php echo $data['citta']; ?>">
                         </td>
                     </tr>
