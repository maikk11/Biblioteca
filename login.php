...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($email_err) && empty($password_err)){
        ...
        $sql = "SELECT idUt, email, password FROM utenti WHERE email = ?";
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                            ...
                            $login_err = "Email o password sbagliati.";
                        }
                    }
                } else{
...
<body>
    ...
    <div class="wrapper">
        <h2>Login</h2>
        <p>Inserire email e password per accedere</p>
        <?php 
        if(!empty($login_err)){
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Non avete un account? <a href="register.php">Registrarsi</a>.</p>
        </form>
    </div>    
    </center>
