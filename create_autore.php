...
<body>
    ...
    <br/>
     ...
     <p><a href="autori.php">Indietro</a>
      <form action="create_autore_db.php" method="post"  onsubmit="return handleData()">
       <table cellpadding="3" cellspacing="0">
     
               <!--Creare un input per il cognome -->
        <tr>
         <td>Cognome</td>
         <td><input type="text" name="cognome" placeholder="Inserire il cognome" required></td>
        </tr>
     
        <!-- Creare un input per il nome -->
        <tr>
         <td>Nome</td>
         <td><input type="text" name="nome" placeholder="Inserire il nome" required></td>
        </tr>
     
        <!-- Creare un input per l'indirizzo -->
        <tr>
         <td>Indirizzo</td>
         <td><input type="text" name="indirizzo" placeholder="Inserire l'indirizzo" required></td>
        </tr> 
